...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <!-- PCEHR Prescription Record Clinical Document:  Global Checks -->

    <!-- Context: ClinicalDocument -->

    <!-- Status: Last Reviewed:
         Status: Last Updated : 8/11/2012 -->


    <pattern name="p-PCEHR_Prescription_Record_Global_Checks-errors"
        id="p-PCEHR_Prescription_Record_Global_Checks-errors"
        see="#p-PCEHR_Prescription_Record_Global_Checks-errors">
...
-->
        ...
        <rule context="ext:asEntityIdentifier">
            ...
            <assert test="@classCode">Error: PCEHR Prescription Record -
            ...
            <assert test="not(@classCode) or normalize-space(@classCode) != ''">Error: PCEHR Prescription Record -
                Global Clinical Document check for "ext:asEntityIdentifier" tag -
            ...
            <assert test="ext:id">Error: PCEHR Prescription Record -
            ...
            <!--
            <assert test="ext:id/@assigningAuthorityName">Error: PCEHR Prescription Record -
            ...
            <!-- Other attributes of "ext:id" are being tested by PCEHR_Prescription_Record_Global_Checks.sch. -->
            ...
            <!-- The attributes of "ext:code" (code, codeSystem, codeSystemName, displayName) are being tested by PCEHR_Prescription_Record_Global_Checks.sch. -->
        ...
        <rule context="ext:assigningGeographicArea">
            ...
            <assert test="@classCode"
                >Error: PCEHR Prescription Record - Global Clinical Document check for
...
-->
        ...
        <rule context = "cda:component/cda:section[not(descendant::cda:component/cda:section) and
            ...
            <assert test = "cda:title"
                ...
                Refer to PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0 and section 3.4.1 and 4.4.1 of the
        ...
        <rule context = "cda:observation/cda:text |
            ...
            <report test = "
                ...
                Check all 'cda:observation/cda:text' or 'cda:observation/cda:value' tags to find
                the incorrect 'mediaType' attribute. Refer to PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0 and section 3.4.1 and 4.4.1 of the
                Common Conformance Profile for Clinical Documents.</report>
        ...
        <rule context = "cda:observationMedia[translate(@ID, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')!='LOGO']">
            ...
            <assert test = "@ID">Error: PCEHR Prescription Record -
                Global Clinical Document check for 'observationMedia' tag -
            ...
            <assert test = "not(@ID) or normalize-space(@ID) != ''">Error: PCEHR Prescription Record -
            ...
            <assert test = "cda:value">Error: PCEHR Prescription Record -
            ...
            <report test = "count(cda:value) > 1">Error: PCEHR Prescription Record -
...
-->
            ...
            <assert test = "cda:reference">Error: PCEHR Prescription Record -
            ...
            <report test = "count(cda:reference) > 1">Error: PCEHR Prescription Record -
                Global Clinical Document check for 'observationMedia/value' tag - The 'reference'

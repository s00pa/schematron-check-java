...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-PCEHR_Dispense_Record_Global_Checks-errors"
        id="p-PCEHR_Dispense_Record_Global_Checks-errors"
        see="#p-PCEHR_Dispense_Record_Global_Checks-errors">


        <!-- BEGIN :: Common Patterns: 9.1 CODE -->
        ...
        <rule
            ...
            <report test="not(@codeSystem) and @code"
                >Error: PCEHR Dispense Record -
                Global Clinical Document check for "cda:code/@code" attribute -
                The 'code' tag 'code' attribute shall not be presented for the missing of 'codeSystem' attribute.
                Check all 'cda:code' tags to find
            ...
            <report test="not(@code) and @displayName"
                >Error: PCEHR Dispense Record -
                Global Clinical Document check for "cda:code/@displayName" attribute -
                The 'code' tag 'displayName' attribute shall not be presented for the missing of 'code' attribute.
                Check all 'cda:code' tags to find
            ...
            <assert test="not(cda:qualifier)"
                ...
                The 'qualifier' tag shall not be presented within 'code'.
        ...
        <rule context="cda:id | ext:id[not(ancestor::ext:entitlement)]">
            ...
            <assert test="@root or @nullFlavor"
                ...
                'root' or 'nullFlavor' attributes. Refer to section 9.2 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</assert>
            ...
            <report test="@root and normalize-space(@root) =  ''"
                ...
                value. Refer to section 9.2 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="@root and
                ...
                >Error: PCEHR Dispense Record -
                Global Clinical Document check for "id" tag -
                The 'id' tag 'extension' attribute shall not be presented for HI or Repository identifiers.
                Check all 'cda:id' tags 'extension' attribute to find the prohibited extension attribute.
                Refer to FAQ Vendor advice regarding OIDs in HL7 CDA documents, and section 9.2 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="@nullFlavor and normalize-space(@nullFlavor) = ''"
                ...
                missing value. Refer to section 9.2 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report
                ...
                'nullFlavor' attribute. Refer to section 9.2 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="@extension and not(@root)"
                ...
                find the 'extension' without 'root' attributes. Refer to section 9.2 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="@assigningAuthorityName and normalize-space(@assigningAuthorityName) = ''"
                ...
                attribute to find the missing value. Refer to section 9.2 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="@displayable and not(@root)"
                ...
                find the 'displayable' without 'root' attributes. Refer to section 9.2 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="@displayable and
                ...
                attribute to find the incorrect value. Refer to section 9.2 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <assert test = "
                ...
                >Error: PCEHR Dispense Record -
                Global Clinical Document check for 'id' tag -
                The 'id' tag 'extension' attribute shall have an valid check digit in the Medicare Card Number. Check all
                'cda:id' or 'ext:id' tags to find the incorrect value.
                Refer to FAQ Vendor advice regarding OIDs in HL7 CDA documents, and section 9.2 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</assert>
...
<!--
            <assert test = "
                ...
                >Error: PCEHR Dispense Record -
                Global Clinical Document check for 'id' tag -
                The 'id' tag 'root' attribute shall have an valid check digit in the OID for Medicare Card Number. Check all
                'cda:id' or 'ext:id' tags to find the incorrect value.
                Refer to FAQ Vendor advice regarding OIDs in HL7 CDA documents, and section 9.2 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</assert>
-->
            ...
            <assert test = "
                ...
                >Error: PCEHR Dispense Record -
                Global Clinical Document check for 'id' tag -
                The 'id' tag 'extension' attribute shall have an valid check digit in the Individual Medicare Card Number. Check all
                'cda:id' or 'ext:id' tags to find the incorrect value.
                Refer to FAQ Vendor advice regarding OIDs in HL7 CDA documents, and section 9.2 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</assert>
...
<!--
            <assert test = "
                ...
                >Error: PCEHR Dispense Record -
                Global Clinical Document check for 'id' tag -
                The 'id' tag 'root' attribute shall have an valid check digit in the OID for Individual Medicare Card Number. Check all
                'cda:id' or 'ext:id' tags to find the incorrect value.
                Refer to FAQ Vendor advice regarding OIDs in HL7 CDA documents, and section 9.2 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</assert>
-->
            ...
            <assert test = "
                ...
                >Error: PCEHR Dispense Record -
                Global Clinical Document check for 'id' tag -
                The 'id' tag 'extension' attribute shall have an valid check digit in the Medicare Provider Number.
                Check all 'cda:id' or 'ext:id' tags to find the incorrect value.
                Refer to FAQ Vendor advice regarding OIDs in HL7 CDA documents, and section 9.2 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</assert>
        ...
        <!-- BEGIN :: Common Patterns: 9.3 TIME -->
        ...
        <rule context="ext:time                                                                  |
                       ...
                       cda:effectiveTime[@xsi:type='TS']                                         |
                       cda:effectiveTime[@xsi:type='IVL_TS']/cda:low                             |
                       cda:effectiveTime[@xsi:type='IVL_TS']/cda:high                            |
                       cda:effectiveTime[@xsi:type='IVL_TS']/cda:center                          |
                       cda:effectiveTime[@xsi:type='PIVL_TS']/cda:phase/cda:low                  |
                       cda:effectiveTime[@xsi:type='PIVL_TS']/cda:phase/cda:high                 |
                       cda:effectiveTime[@xsi:type='PIVL_TS']/cda:phase/cda:center               |
                       ...
                       cda:time[@xsi:type='TS']                                                  |
                       cda:time[@xsi:type='IVL_TS']/cda:low                                      |
                       cda:time[@xsi:type='IVL_TS']/cda:high                                     |
                       cda:time[@xsi:type='IVL_TS']/cda:center                                   |
                       cda:time[@xsi:type='PIVL_TS']/cda:phase/cda:low                           |
                       cda:time[@xsi:type='PIVL_TS']/cda:phase/cda:high                          |
                       cda:time[@xsi:type='PIVL_TS']/cda:phase/cda:center                        |
...
-->
        ...
        <!--
         ...
         -->
        <rule context="cda:effectiveTime[@xsi:type='IVL_TS']                                     |
                       cda:effectiveTime[@xsi:type='PIVL_TS']/cda:phase                          |
...
-->
        ...
        <rule context="cda:effectiveTime[@xsi:type='PIVL_TS']">
...
-->
        ...
        <rule context="cda:effectiveTime[@xsi:type='IVL_TS']/cda:width                          |
                       cda:effectiveTime[@xsi:type='PIVL_TS']/cda:phase/cda:width               |
                       cda:effectiveTime[@xsi:type='PIVL_TS']/cda:period                        |
                       cda:effectiveTime[@xsi:type='PIVL_TS']/cda:frequency/cda:numerator       |
                       cda:effectiveTime[@xsi:type='PIVL_TS']/cda:frequency/cda:denominator     |
        ...
        <!-- BEGIN :: Common Patterns: 9.4 ENTITY IDENTIFIER -->
        ...
        <rule context="ext:asEntityIdentifier">
            ...
            <assert test="@classCode">Error: PCEHR Dispense Record -
                ...
                Refer to section 9.4 Entity Identifier of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</assert>

            <assert test="not(@classCode) or normalize-space(@classCode) != ''">Error: PCEHR Dispense Record -
                Global Clinical Document check for "ext:asEntityIdentifier" tag -
            ...
            <assert test="ext:id">Error: PCEHR Dispense Record -
                ...
                the missing 'id' tag. Refer to section 9.4 Entity Identifier of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</assert>
            ...
            <assert test="ext:id/@assigningAuthorityName">Error: PCEHR Dispense Record -
                ...
                'assigningAuthorityName' attribute. Refer to section 9.4 Entity Identifier of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</assert>
            -->

            <!-- Other attributes of "ext:id" are being tested by PCEHR_Dispense_Record_Global_Checks.sch. -->
            ...
            <report test="count(ext:code) > 1"
                ...
                to find the duplicate 'code' tag. Refer to section 9.4 Entity Identifier of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>

            <!-- The attributes of "ext:code" (code, codeSystem, codeSystemName, displayName) are being tested by PCEHR_Dispense_Record_Global_Checks.sch. -->
            ...
            <report test="count(ext:assigningGeographicArea) > 1"
                ...
                tag. Refer to section 9.4 Entity Identifier of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
        ...
        <!-- BEGIN :: Common Patterns: 9.5 PERSON NAME -->
        ...
        <rule context="cda:name[not(
            ...
            <assert test="
                ...
                Refer to section 9.5 Person Name of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</assert>
            ...
            <report test="cda:prefix and normalize-space(cda:prefix ) = ''"
                ...
                value. Refer to section 9.5 Person Name of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="count(cda:family) > 1"
                ...
                child tag. Refer to section 9.5 Person Name of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
        ...
        <!-- BEGIN :: Common Patterns: 9.6 ADDRESS -->
        ...
        <rule context="cda:addr[not(ancestor::cda:birthplace)]">
            ...
            <assert test="
                ...
                >Error: PCEHR Dispense Record - Global Clinical Document check for 'addr' tag -
                The 'addr' tag shall not contain an immediate text value. Check all 'cda:addr' tags to
                find the incorrect tag. Refer to section 9.6 Address of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</assert>
            ...
            <report test="child::* and @nullFlavor"
                ...
                Refer to section 9.6 Address of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="cda:streetAddressLine and normalize-space(cda:streetAddressLine) = ''"
                ...
                find the incorrect 'streetAddressLine' tag. Refer to section 9.6 Address of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="count(cda:unitType) > 1"
                ...
                to find the duplicate 'unitType' tag. Refer to section 9.6 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="count(cda:unitID) > 1"
                ...
                the duplicate 'unitID' tag. Refer to section 9.6 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="cda:unitID and normalize-space(cda:unitID) = ''"
                ...
                empty 'unitID' tag. Refer to section 9.6 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="count(cda:additionalLocator) > 5"
                ...
                The 'additionalLocator' tag shall appear only 5 times. Refer to section 9.6 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="cda:additionalLocator and normalize-space(cda:additionalLocator) = ''"
                ...
                to find the empty 'additionalLocator' tag(s). Refer to section 9.6 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="count(cda:houseNumber) > 1"
                ...
                find the duplicate 'houseNumber' tag. Refer to section 9.6 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="cda:houseNumber and normalize-space(cda:houseNumber) = ''"
                ...
                the empty 'houseNumber' tag. Refer to section 9.6 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="count(cda:streetName) > 1"
                ...
                find the duplicate 'streetName' tag. Refer to section 9.6 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="cda:streetName and normalize-space(cda:streetName) = ''"
                ...
                to find the empty 'streetName' tag. Refer to section 9.6 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="count(cda:streetNameType) > 1"
                ...
                to find the duplicate 'streetNameType' tag. Refer to section 9.6 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="cda:streetNameType and normalize-space(cda:streetNameType) = ''"
                ...
                to find the empty 'streetNameType' tag. Refer to section 9.6 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="count(cda:direction) > 1"
                ...
                find the duplicate 'direction' tag. Refer to section 9.6 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>            
            ...
            <report test="count(cda:deliveryAddressLine) > 2"
                ...
                to find the excessive 'deliveryAddressLine' tag(s). Refer to section 9.6 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report
                ...
                to find the empty 'deliveryAddressLine' tag(s). Refer to section 9.6 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="count(cda:city) > 1"
                ...
                duplicate 'city' tag. Refer to section 9.6 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="cda:city and normalize-space(cda:city) = ''"
                ...
                empty 'city' tag. Refer to section 9.6 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="count(cda:state) > 1"
                ...
                the duplicate 'state' tag. Refer to section 9.6 and 10.10 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="
                ...
                Australian State/Territory Identifier - Postal. Refer to section 9.6 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="
                ...
                'state' tag(s). Refer to section 9.6 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="count(cda:country) > 1"
                ...
                the duplicate 'country' tag. Refer to section 9.6 Address of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="cda:country and normalize-space(cda:country) = ''"
                ...
                empty 'country' tag. Refer to section 9.6 Address of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
...
<!--
            <report test="
                ...
                The 'addr' tag 'use' attribute shall contain a value. Refer to section 9.6 and 10.6 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
-->
        ...
        <!-- BEGIN :: Common Patterns: 9.7 ELECTRONIC COMMUNICATION DETAIL -->
        ...
        <rule context="cda:telecom">
            ...
            <assert test="@value or @nullFlavor"
                ...
                the missing value. Refer to section 9.7 Electronic Communication Detail of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</assert>
            ...
            <assert test="not(@value) or normalize-space(@value) !=''"
                ...
                Refer to 9.7 Electronic Communication Detail of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</assert>
            ...
            <report test="
                ...
                attributes to find the incorrect value. Refer to section 9.7 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
            -->
        ...
        <rule context = "cda:component/cda:section[not(descendant::cda:component/cda:section) and
            ...
            <assert test = "cda:title"
                ...
                Refer to PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0 and section 3.4.1 and 4.4.1 of the
        ...
        <rule context = "cda:observation/cda:text |
            ...
            <report test = "
                ...
                Check all 'cda:observation/cda:text' or 'cda:observation/cda:value' tags to find
                the incorrect 'mediaType' attribute. Refer to PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0 and section 3.4.1 and 4.4.1 of the
                Common Conformance Profile for Clinical Documents.</report>
        ...
        <rule context = "cda:observationMedia[translate(@ID, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')!='LOGO']">
            ...
            <assert test = "@ID">Error: PCEHR Dispense Record -
                Global Clinical Document check for 'observationMedia' tag -
            ...
            <assert test = "not(@ID) or normalize-space(@ID) != ''">Error: PCEHR Dispense Record -
            ...
            <assert test = "cda:value">Error: PCEHR Dispense Record -
            ...
            <report test = "count(cda:value) > 1">Error: PCEHR Dispense Record -
        ...
        <rule context = "cda:observationMedia[translate(@ID, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')='LOGO']/cda:value">
            ...
            <assert test = "not(@xsi:type) or normalize-space(@xsi:type) = '' or @xsi:type = 'ED'"
                >Error: PCEHR Dispense Record -
                Global Clinical Document check for 'observationMedia' tag -
            ...
            <report test = "@xsi:type and normalize-space(@xsi:type) != '' and @xsi:type != 'ED'"
                >Error: PCEHR Dispense Record -
                Global Clinical Document check for 'observationMedia' tag -
                The 'value' tag 'xsi:type' attribute shall contain the value 'ED'
                Check all 'cda:observationMedia' tags with 'ID=LOGO' attribute to find
...
-->
            ...
            <assert test = "cda:reference">Error: PCEHR Dispense Record -
            ...
            <report test = "count(cda:reference) > 1">Error: PCEHR Dispense Record -
                Global Clinical Document check for 'observationMedia/value' tag - The 'reference'

...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-PCEHR_Dispense_Record_DataType_Global_Checks-errors"
        id="p-PCEHR_Dispense_Record_DataType_Global_Checks-errors"
        see="#p-PCEHR_Dispense_Record_DataType_Global_Checks-errors">
        ...
        <rule context="cda:value[@xsi:type='CS']">
            ...
            <assert test="@code">Error: PCEHR Dispense Record -
                Global Clinical Document check for value datatype -
            ...
            <assert test="not(@code) or normalize-space(@code) != ''">Error: PCEHR Dispense Record -
                Global Clinical Document check for value datatype -
                The 'value' tag 'code' attribute shall contain a value.
                Check all 'cda:value' tags with 'xsi:type=CS' attribute to find the
        ...
        <rule context="cda:value[@xsi:type='INT']">
            ...
            <report test="@value and normalize-space(@value) = ''">Error: PCEHR Dispense Record -
                Global Clinical Document check for value datatype -
                The 'value' tag 'value' attribute shall contain a value.
                Check all 'cda:value' tags with 'xsi:type=INT' attribute to find the
                'value' attribute of missing value. Refer to sections of the
        ...
        <rule context="cda:value[@xsi:type='PQ']">
            ...
            <report test="@unit and normalize-space(@unit) = ''">Error: PCEHR Dispense Record -
                Global Clinical Document check for value datatype -
            ...
            <report test="@unit and not(@value)">Error: PCEHR Dispense Record -
                Global Clinical Document check for value datatype -

...
public class TestSchematronCheckAdvanceCareDirective {
    ...
    public void testSimpleInterface() {
        ...
        result = Schematron.check("resources/test/AdvanceCareDirective",
                "ccd-3A.sch",
    ...
    public void testSimpleInterfaceWithDocument() {
        ...
        SchematronCheckResult result;
        Document ePrescription = readDocument("resources/test/generated_xml/advance_care_directive/acd-max-java.xml");
        result = Schematron.check("resources/test/AdvanceCareDirective",
                "ccd-3A.sch",
                ePrescription);
